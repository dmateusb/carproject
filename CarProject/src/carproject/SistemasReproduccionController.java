 ...
 * @author david
 */
public class SistemasReproduccionController implements Initializable {
    ...
    public void openFXML() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SistemasReproduccion.fxml"));
        Parent root = (BorderPane) loader.load(getClass().getResource("SistemasReproduccion.fxml").openStream());
