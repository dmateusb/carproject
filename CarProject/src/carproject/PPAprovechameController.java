...
public class PPAprovechameController implements Initializable {
    ...
    public void openFXML() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("PPAprovechame.fxml"));
        Parent root = (BorderPane) loader.load(getClass().getResource("PPAprovechame.fxml").openStream());
