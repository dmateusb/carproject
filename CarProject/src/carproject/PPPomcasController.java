 ...
 * @author david
 */
public class PPPomcasController implements Initializable {
    ...
    public void openFXML() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("PPPomcas.fxml"));
        Parent root = (BorderPane) loader.load(getClass().getResource("PPPomcas.fxml").openStream());
