 ...
 * @author david
 */
public class PPSistemasProcasController implements Initializable {
    ...
    public void openFXML() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("PPSistemasProcas.fxml"));
        Parent root = (BorderPane) loader.load(getClass().getResource("PPSistemasProcas.fxml").openStream());
